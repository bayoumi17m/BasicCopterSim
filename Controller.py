...
class Controller_Point2Point(object):
    """docstring forController_Point2Point."""
...
class Controller_Velocity(Controller_Point2Point):
    """docstring for Controller_Velocity."""
    def update(self):
        [dest_x,dest_y,dest_z] = self.target
        [x,y,z,x_dot,y_dot,z_dot,theta,phi,gamma,theta_dot,phi_dot,gamma_dot] = self.get_state(self.quad_identifier)
